...
def obtener_ip_privada():
    try:
        ...
        # Crea un socket y se conecta a un host remoto para obtener la IP local
        s = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        s.connect(("8.8.8.8", 80))  # Google DNS como ejemplo
...
# Obtiene la IP pública y privada
...
nombre_usuario = "Fredy Santander"
boca_abierta = False
